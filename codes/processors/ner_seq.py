...
class MSRAProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["X", 'B-NR', 'B-NS', 'B-NT',
                'I-NR', 'I-NS', 'I-NT',
                'O', 'S-NR', 'S-NS', 'S-NT', "[START]", "[END]"]
...
if __name__ == '__main__':
    cnerprocessor = CnerProcessor()
    cluenerprocessor = CluenerProcessor()
    msraprocessor = MSRAProcessor()
    label = cnerprocessor.get_labels()
    print(label)
    print(cluenerprocessor.get_labels())
    print(msraprocessor.get_labels())