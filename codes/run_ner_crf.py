...
def main():
    ...
    init_logger(log_file=args.output_dir+'.log')
...
if __name__ == "__main__":
    ...
    # config = BertConfig.from_pretrained('outputsbert',num_labels=23)
    # tokenizer = BertTokenizer.from_pretrained('outputsbert/vocab.txt')
    # model = BertCrfForNer.from_pretrained('outputsbert',config = config)
    # model.to(device)
    #
    ...
    #
    # textlist = ['北京大学是中国的最高学府。','清华大学和北京大学是最好的两个学校。','中国是种植小麦最早的国家。']
    # # text = '北京大学是中国的最高学府。'
